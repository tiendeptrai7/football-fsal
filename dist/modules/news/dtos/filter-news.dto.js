...
class FilterNewsDto extends (0, swagger_1.OmitType)(base_filter_dto_1.BaseFilterParamDto, [
    'date_from',
    'date_to',
]) {
    date_from;
...
], FilterNewsDto.prototype, "date_from", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsISO8601)(),
    ...
    (0, swagger_1.ApiProperty)({ required: false }),
    __metadata("design:type", Date)
], FilterNewsDto.prototype, "date_to", void 0);
