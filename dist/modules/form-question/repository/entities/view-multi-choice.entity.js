...
exports.ViewSubmitMultiChoice = void 0;
...
let ViewSubmitMultiChoice = class ViewSubmitMultiChoice {
    form_id;
    event_guest_id;
    form_type;
    order;
...
exports.ViewSubmitMultiChoice = ViewSubmitMultiChoice;
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.ViewColumn)(),
    __metadata("design:type", Number)
], ViewSubmitMultiChoice.prototype, "form_id", void 0);
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.ViewColumn)(),
    __metadata("design:type", Number)
], ViewSubmitMultiChoice.prototype, "event_guest_id", void 0);
__decorate([
    (0, typeorm_1.ViewColumn)(),
    __metadata("design:type", Number)
], ViewSubmitMultiChoice.prototype, "form_type", void 0);
__decorate([
    (0, typeorm_1.ViewColumn)(),
    __metadata("design:type", Number)
], ViewSubmitMultiChoice.prototype, "order", void 0);
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.ViewColumn)(),
    __metadata("design:type", Number)
], ViewSubmitMultiChoice.prototype, "question_id", void 0);
__decorate([
    (0, typeorm_1.ViewColumn)(),
    __metadata("design:type", String)
], ViewSubmitMultiChoice.prototype, "question_content", void 0);
__decorate([
    (0, typeorm_1.ViewColumn)(),
    __metadata("design:type", Number)
], ViewSubmitMultiChoice.prototype, "answer_id", void 0);
__decorate([
    (0, typeorm_1.ViewColumn)(),
    __metadata("design:type", String)
], ViewSubmitMultiChoice.prototype, "answer_text", void 0);
__decorate([
    (0, typeorm_1.ViewColumn)(),
    __metadata("design:type", String)
], ViewSubmitMultiChoice.prototype, "answer_content", void 0);
exports.ViewSubmitMultiChoice = ViewSubmitMultiChoice = __decorate([
    (0, typeorm_1.ViewEntity)({
        name: 'view_submit_multi_choice',
        expression: (dataSource) => dataSource
            ...
            .where(`submission.question_type = ${app_enum_1.EQuestionType.multi_choice}`)
            .andWhere(`submission.id IS NOT NULL`),
    })
], ViewSubmitMultiChoice);
//# sourceMappingURL=view-multi-choice.entity.js.map