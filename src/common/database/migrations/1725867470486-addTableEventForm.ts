...
export class AddTableEventForm1725867470486 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "event_form_detail" ("created_at" datetime2 NOT NULL CONSTRAINT "DF_53e8742de4e9002bceb82a335ff" DEFAULT getdate(), "updated_at" datetime2 NOT NULL CONSTRAINT "DF_6f3e61c3ad78847439079e922f5" DEFAULT getdate(), "id" int NOT NULL IDENTITY(1,1), "content" nvarchar(1000) NOT NULL, "type" nvarchar(255) NOT NULL, "format" nvarchar(255) NOT NULL, "is_required" tinyint NOT NULL CONSTRAINT "DF_ee9bcf29b70139151603051399d" DEFAULT 1, "event_form_id" int, CONSTRAINT "PK_31b062603e26c6d526a404eb9d8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
