...
export class AfterRef1725937291329 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "event_registration" DROP COLUMN "ref_id"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "event_form_option" ALTER COLUMN "event_form_detail_id" int NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "event_guest" ADD CONSTRAINT "FK_84001529739b60cd6ed906ace9b" FOREIGN KEY ("ref_id") REFERENCES "event_guest"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "event_guest" DROP CONSTRAINT "FK_84001529739b60cd6ed906ace9b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "event_form_option" DROP CONSTRAINT "FK_120b67aa01a8042ac7c5fef8b1d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "event_form_option" ALTER COLUMN "event_form_detail_id" int`,
    );
    await queryRunner.query(
      `ALTER TABLE "event_form_option" ADD CONSTRAINT "FK_120b67aa01a8042ac7c5fef8b1d" FOREIGN KEY ("event_form_detail_id") REFERENCES "event_form_detail"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "event_registration" ADD "ref_id" int`,
    );
    await queryRunner.query(
